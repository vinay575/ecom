...
export function OurStorySection() {
  ...
  return (
    <section className="relative py-20 bg-gradient-to-b from-white via-gray-50 to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight  bg-clip-text text-transparent" style={{ color: "hsl(23.95deg 95% 52.94%)" }}>
              Meet Nano Flows AI
            </h2>
